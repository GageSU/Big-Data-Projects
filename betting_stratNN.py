...
model =MLPClassifier(hidden_layer_sizes=(40,10), random_state=1, max_iter=500)
...
mlp_output = getStrategyPayout(X,Y,0.2,model,stake_per_bet =100, capital=10000, prob_threshold=0.6, scale=False)
